...
export function StudentDashboardClient({ data }: { data: DashboardData }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", flex: 1, overflowY: "auto" }}>
      ...
      {/* METRICS SECTION */}
      <div style={{ padding: "12px 20px", display: "grid", gridTemplateColumns: "1fr 300px", gap: "12px" }}>
        {/* Metrics + Timeline */}
        <div style={{
      ...
      <div style={{ padding: "12px 20px 20px", flex: 1 }}>
        <div style={{
          ...
          display: "grid", gridTemplateColumns: "240px 1fr", height: "400px", overflow: "hidden"
        }}>
          {/* Task List */}
