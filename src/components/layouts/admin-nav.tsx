...
const ADMIN_NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="19" height="19" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 15s1-1 5-1 5 1 5 1V3c0 0-1-1-5-1s-5 1-5 1"/>
      </svg>
    ),
  },
  {
...
function AdminPillSidebar({ activePath = "/admin/dashboard" }: { activePath?: string }) {
  return (
    <nav style={{
      width: "72px",
      flexShrink: 0,
...
function AdminTopNav({ adminName, isDark, setIsDark }: { adminName: string; isDark: boolean; setIsDark: (val: boolean) => void }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: isDark ? "#2a1414" : "#ffe8e8", borderRadius: "22px", padding: "4px 12px", flexShrink: 0,
      }}>
        <span style={{
          padding: "3px 0", borderRadius: "16px", fontSize: "11px",
          color: "#e87070", fontWeight: 600,
        }}>Admin Account</span>
      </div>
...
export { AdminPillSidebar, AdminTopNav };
